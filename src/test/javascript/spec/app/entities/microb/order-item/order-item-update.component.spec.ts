...
import { OrderItemUpdateComponent } from 'app/entities/microb/order-item/order-item-update.component';
import { OrderItemService } from 'app/entities/microb/order-item/order-item.service';
import { OrderItem } from 'app/shared/model/microb/order-item.model';
