...
import com.example.microservices.JhcognitoappApp;

import com.example.microservices.config.Constants;
import com.example.microservices.config.TestSecurityConfiguration;
import com.example.microservices.config.audit.AuditEventConverter;
import com.example.microservices.domain.PersistentAuditEvent;
...
import static com.example.microservices.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;

/**
 * Integration tests for {@link CustomAuditEventRepository}.
 */
@SpringBootTest(classes = {JhcognitoappApp.class, TestSecurityConfiguration.class})
@Transactional
