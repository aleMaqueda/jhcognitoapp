...
import { IShipment } from 'app/shared/model/microa/shipment.model';
...
export class ShipmentComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.shipmentService
      ...
      .subscribe(
        (res: HttpResponse<IShipment[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IShipment[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
