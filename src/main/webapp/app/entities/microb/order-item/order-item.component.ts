...
import { IOrderItem } from 'app/shared/model/microb/order-item.model';
...
export class OrderItemComponent implements OnInit, OnDestroy {
  ...
  protected onSuccess(data: IOrderItem[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
